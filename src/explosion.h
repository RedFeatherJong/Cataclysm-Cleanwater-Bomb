...
struct explosion_data {
    ...
    // Modern light-overlay recipe for this blast's visual (see explosion_light).
    // Empty -> the built-in "default_blast" recipe. Set to "legacy_sprite" to
    // opt back into the old expanding-sprite animation.
    explosion_light_str_id light_effect;
